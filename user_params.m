...
enable_hotcase = false;

enable_dust_five = false;
enable_dust_ten = false;
enable_dust_fifteen = false;

max_charge_period = 0; %[Hrs]
max_shadow_time   = 5*60; %[secs, 5 mins total]

%%
init_soc = 0.85; %start simulation with this state-of-charge           
...
input_velocity = 4;             % specify the linear velocity of the rover throughout the sim
